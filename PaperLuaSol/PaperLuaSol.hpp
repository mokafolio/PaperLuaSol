...
STICK_API inline void registerPaper(sol::state_view & _lua, const stick::String & _namespace = "")
{
    ...
    tbl.new_usertype<Item>(
        ...
        &Item::parent, "setPosition", &Item::setPosition, "setPivot", &Item::setPivot, "setVisible",
        &Item::setVisible, "setName", &Item::setName, "setTransform", &Item::setTransform,
        "translateTransform", (void (Item::*)(const Vec2f &)) & Item::translateTransform,
        "scaleTransform",
