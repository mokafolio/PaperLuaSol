...
STICK_API inline void registerPaper(sol::state_view & _lua, const stick::String & _namespace = "")
{
    ...
    tbl.new_enum("Smoothing",                         //
                 "Continuous", Smoothing::Continuous, //
                 "Asymmetric", Smoothing::Asymmetric, //
                 "CatmullRom", Smoothing::CatmullRom, //
                 "Geometric", Smoothing::Geometric);
    ...
    tbl.new_usertype<Segment>(
        "Segment", "new", sol::no_constructor, "setPosition", &Segment::setPosition, "setHandleIn",
    ...
    tbl.new_usertype<CurveLocation>(
        ...
        &CurveLocation::normal, "tangent", &CurveLocation::tangent, "curvature",
        &CurveLocation::curvature, "angle", &CurveLocation::angle, "parameter",
        &CurveLocation::parameter, "offset", &CurveLocation::offset, "isValid",
        &CurveLocation::isValid, "curve", &CurveLocation::curve);

    tbl.new_usertype<Curve>(
        "Curve", "new", sol::no_constructor, "path", &Curve::path, "setPositionOne",
        &Curve::setPositionOne, "setHandleOne", &Curve::setHandleOne, "setPositionTwo",
        &Curve::setPositionTwo, "setHandleTwo", &Curve::setHandleTwo, "positionOne",
        &Curve::positionOne, "positionTwo", &Curve::positionTwo, "handleOne", &Curve::handleOne,
        "handleOneAbsolute", &Curve::handleOneAbsolute, "handleTwo", &Curve::handleTwo,
        "handleTwoAbsolute", &Curve::handleTwoAbsolute, "positionAt", &Curve::positionAt,
        "normalAt", &Curve::normalAt, "tangentAt", &Curve::tangentAt, "curvatureAt",
        &Curve::curvatureAt, "angleAt", &Curve::angleAt, "positionAtParameter",
        &Curve::positionAtParameter, "normalAtParameter", &Curve::normalAtParameter,
        "tangentAtParameter", &Curve::tangentAtParameter, "curvatureAtParameter",
        &Curve::curvatureAtParameter, "angleAtParameter", &Curve::angleAtParameter,
        "parameterAtOffset", &Curve::parameterAtOffset, "closestParameter",
        (Float(Curve::*)(const Vec2f &) const) & Curve::closestParameter, "lengthBetween",
        &Curve::lengthBetween, "pathOffset", &Curve::pathOffset, "closestCurveLocation",
        &Curve::closestCurveLocation, "curveLocationAt", &Curve::curveLocationAt,
        "curveLocationAtParameter", &Curve::curveLocationAtParameter, "isLinear", &Curve::isLinear,
        "isStraight", &Curve::isStraight, "isArc", &Curve::isArc, "isOrthogonal",
    ...
    tbl.new_usertype<BaseGradient>("BaseGradient", "new", sol::no_constructor, "setOrigin",
                                   &BaseGradient::setOrigin, "setDestination",
                                   &BaseGradient::setDestination, "addStop", &BaseGradient::addStop,
                                   "origin", &BaseGradient::origin, "destination",
                                   &BaseGradient::destination, "stops", &BaseGradient::stops);

    tbl.new_usertype<LinearGradient>("LinearGradient", sol::base_classes,
                                     sol::bases<BaseGradient>(), "new", sol::no_constructor);
    ...
    tbl.new_usertype<Item>(
        "Item", "new", sol::no_constructor, "addChild", &Item::addChild, "insertAbove",
        &Item::insertAbove, "insertBelow", &Item::insertBelow, "sendToFront", &Item::sendToFront,
        "sendToBack", &Item::sendToBack, "reverseChildren", &Item::reverseChildren, "remove",
        &Item::remove, "removeChildren", &Item::removeChildren, "name", &Item::name, "parent",
        &Item::parent, "setPosition", &Item::setPosition, "setPivot", &Item::setPivot,
        "removePivot", &Item::removePivot, "setVisible", &Item::setVisible, "setName",
        &Item::setName, "setTransform", &Item::setTransform, "translateTransform",
        (void (Item::*)(const Vec2f &)) & Item::translateTransform, "scaleTransform",
        sol::overload((void (Item::*)(const Vec2f &)) & Item::scaleTransform,
        ...
        "transformItem", (void (Item::*)(const Mat32f &)) & Item::transform, "translate",
        (void (Item::*)(const Vec2f &)) & Item::translate, "scale",
        ...
        "applyTransform", &Item::applyTransform, "transform",
        (const Mat32f & (Item::*)() const) & Item::transform, "rotation", &Item::rotation,
        "translation", &Item::translation, "scaling", &Item::scaling, "absoluteRotation",
        &Item::absoluteRotation, "absoluteTranslation", &Item::absoluteTranslation,
        "absoluteScaling", &Item::absoluteScaling, "bounds", &Item::bounds, "handleBounds",
        ...
        "removeStroke", &Item::removeStroke, "setFill",
        ...
        "removeFill", &Item::removeFill, "setWindingRule", &Item::setWindingRule, "strokeJoin",
        &Item::strokeJoin, "strokeCap", &Item::strokeCap, "miterLimit", &Item::miterLimit,
        "strokeWidth", &Item::strokeWidth, "dashArray", &Item::dashArray, "dashOffset",
        &Item::dashOffset, "windingRule", &Item::windingRule, "scaleStroke", &Item::scaleStroke,
    ...
    tbl.new_usertype<Path>(
        ...
        &Path::quadraticCurveTo, "curveTo", &Path::curveTo, "arcThrough",
        (Error(Path::*)(const Vec2f &, const Vec2f &)) & Path::arcTo, "arcTo",
        sol::overload((Error(Path::*)(const Vec2f &, bool)) & Path::arcTo,
                      (Error(Path::*)(const Vec2f &, const Vec2f &)) & Path::arcTo),
        "cubicCurveBy", &Path::cubicCurveBy, "quadraticCurveBy", &Path::quadraticCurveBy, "curveBy",
        &Path::curveBy, "closePath", &Path::closePath, "smooth",
        sol::overload([](Path & _self) { _self.smooth(); },
                      (void (Path::*)(Smoothing, bool)) & Path::smooth,
                      (void (Path::*)(Int64, Int64, Smoothing)) & Path::smooth),
        "simplify", &Path::simplify, "addSegment", &Path::addSegment, "removeSegment",
        &Path::removeSegment, "removeSegments",
        sol::overload((void (Path::*)(Size)) & Path::removeSegments,
                      (void (Path::*)(Size, Size)) & Path::removeSegments,
                      (void (Path::*)()) & Path::removeSegments),
        "positionAt", &Path::positionAt, "normalAt", &Path::normalAt, "tangentAt", &Path::tangentAt,
        "curvatureAt", &Path::curvatureAt, "angleAt", &Path::angleAt, "reverse", &Path::reverse,
        "setClockwise", &Path::setClockwise, "flatten", &Path::flatten, "flattenRegular",
        &Path::flattenRegular, "regularOffset", &Path::regularOffset, "closestCurveLocation",
        ...
        "curveLocationAt", &Path::curveLocationAt, "length", &Path::length, "area", &Path::area,
        "isClosed", &Path::isClosed, "isClockwise", &Path::isClockwise, "contains", &Path::contains,
        "segment", (Segment(Path::*)(stick::Size)) & Path::segment, "curve",
        (Curve(Path::*)(stick::Size)) & Path::curve, "segmentCount", &Path::segmentCount,
        "curveCount", &Path::curveCount, "intersections",
    ...
    tbl.new_usertype<Document>(
        ...
        sol::constructors<Document(), Document(const char *)>(), "createGroup",
        ...
        "createEllipse",
        sol::overload([](Document & _self, const Vec2f & _pos,
        ...
        "createRectangle",
        sol::overload([](Document & _self, const Vec2f & _min,
        ...
        "setSize", &Document::setSize, "width", &Document::width, "height", &Document::height,
        "size", &Document::size);
    ...
    tbl.new_usertype<RenderInterface>("RenderInterface", "new", sol::no_constructor, "setViewport",
                                      &RenderInterface::setViewport, "setProjection",
                                      &RenderInterface::setProjection, "document",
                                      &RenderInterface::document, "draw", &RenderInterface::draw);

    tbl.new_usertype<paper::tarp::TarpRenderer>(
        "TarpRenderer", sol::base_classes, sol::bases<RenderInterface>(), sol::call_constructor,
